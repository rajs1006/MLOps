...
bm_source = CustomRequestDataSource(
    ...
    path="/Series",
    params=paramsBM,
    field_mapping={"ie.pricing.imbalanceprice(4423)": "TARGET1"},
...
id1_source = CustomRequestDataSource(
    ...
    path="/Series",
    params=paramsID1,
    field_mapping={"ie.pricing.intraday1price(4425)": "TARGET2"},
    timestamp_field="DeliveryBst",
)
...
da_source = CustomRequestDataSource(
    ...
    path="/Series",
    params=paramsDA,
    field_mapping={"ie.pricing.dayaheadprice(4424)": "FEATURE1"},
    timestamp_field="DeliveryBst",
)
...
def spread_fv(inputs: pd.DataFrame) -> pd.DataFrame:
    ...
    df["TARGET"] = inputs["TARGET1"] - inputs["TARGET2"]
    return df
